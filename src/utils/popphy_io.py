import os
from sklearn.metrics import roc_auc_score, matthews_corrcoef, precision_score, recall_score, f1_score,accuracy_score
...
def get_stat_dict(y, probs):
	...
	stat_dict["Accuracy"]= accuracy_score(y, lab)
