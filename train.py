...
# def train_PopPhy():
	...
	my_maps, _, _, _, tree_features, labels, label_set, g, feature_df = prepare_data(path, config,k,m)
	...
	print("k=",k)
	print("m=",m)
	txtName=str(dataset)+"result.csv"
	...
	txtresult = open ( txtName , "a" )
	txtresult.write(stat_df.mean(1).str())
	txtresult.write("k=",k,"\n m=",m)
...
if __name__ == "__main__":
	...
	#看好m、k、b
	m=5
	for k in np.arange(-0.8,-0.3,0.2):
		train_PopPhy(k,m)
	# train_PopPhy()
